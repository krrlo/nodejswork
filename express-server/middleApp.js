...
app.use(defaultParser);   // jsonParser 넣으면 모든 서버에서 제이슨으로만 사용자가 입력하게..?
...
const corsOptions = {                       //서버측에서 CORS를 허용해놔야함, 
    origin : 'http://192.168.0.36:5500',  //허용할 도메인 설정  니가만든 페이지는아니지만 응답해라..라고 서버에 알려줌 
